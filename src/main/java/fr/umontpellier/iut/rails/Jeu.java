...
public class Jeu extends Task<Void> implements IJeu {
    ...
    //MODIF avatarJoueurs
    public Jeu(String[] nomJoueurs, String[] avatarJoueurs, IJoueur.Couleur[] couleursJoueurs) {
        ...
        for (int i=0 ; i < nomJoueurs.length; i++) {
            Joueur j = new Joueur(nomJoueurs[i], avatarJoueurs[i], this, couleursJoueurs[i]);
            for (int k = 0; k < 4; k++) {
